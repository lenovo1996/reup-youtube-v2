	<div class="col-md-12">
		<div class="panel panel-danger">
			<div class="panel-heading">Get information video with channel</div>
			<div class="panel-body">
				<div class="form-group">
					<div class="input-group"><span class="input-group-addon" id="sizing-addon1">Channel Id:</span>
						<input id="txtKeyword" type="text" class="form-control" placeholder="UCiZJtnTQunvoY0xgv-Ce_rg" aria-describedby="sizing-addon1">
