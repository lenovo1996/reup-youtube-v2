...
?>
	...
	<div class="col-md-12">
		<div class="panel panel-danger">
			<div class="panel-heading">List saved video</div>
	...
	<script>
		...
		function upload_video (element) {
			...
			$.ajax ({
				...
				beforeSend: function(){
			        $(element).prop("disabled", true).html('<i class="glyphicon glyphicon-refresh gly-spin"></i>');
				},
				success: function (data) {
					if(data.result){
						$("#video_" + id).remove();
						alertify.success('Upload thành công id: ' + id);
					}else{
